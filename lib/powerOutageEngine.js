...
function evaluatePowerOutageRisk(input) {
  ...
  if (!matchedRule) {
    return {
      ...
      relatedTools: [
        {
          href: "/food-left-out-calculator/",
          label: "Food left out calculator"
        },
        {
          href: "/printable-food-storage-chart/",
          label: "Printable food storage chart"
        },
        {
          href: "/disclaimer/",
          label: "Disclaimer"
  ...
  } else if (freezerEffective >= 32 || debug.freezer_assumed_above_32 || normalized.freezerOpened) {
    relatedTools.push(
      {
        href: "/can-i-refreeze-this/",
        label: "Can I refreeze this?"
      ...
      {
        href: "/thermometer-recommendations/",
        label: "Thermometer recommendations"
      },
      {
        href: "/printable-food-storage-chart/",
        label: "Printable food storage chart"
